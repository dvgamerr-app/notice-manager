      ...
      <b-col class="d-none" md="4">
        ...
        <div v-for="e in bot" :key="e._id">
          ...
          <b-progress :max="e.stats.limited" variant="info" height=".9rem" class="mb-3">
            <b-progress-bar :value="getLimitPercent(e.stats.usage, e.stats.limited)" :label-html="String(e.stats.usage)" />
            <b-progress-bar :value="getDayPercent(e.stats.usage, e.stats.limited)" :show-value="false" variant="default" />
          </b-progress>
        </div>
        <h5>
