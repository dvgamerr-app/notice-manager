<template>
  ...
  <b-tabs pills card vertical nav-wrapper-class="aside overflow-auto border-right">
  ...
  <!-- <div class="d-flex">
    <aside class="overflow-auto flex-shrink-0 flex-grow-0 position-relative border-right">
